...
- **교차-실행 도메인 메모리 (Tier II, `.harness/memory/`)** — 이 하네스가 *반복 실행*을 거쳐 도메인 지식을
  ...
  - **작업 시작 시 회상**: `Grep "ticket triage" .harness/memory/runs/index.jsonl` 로 과거 유사 실행을
